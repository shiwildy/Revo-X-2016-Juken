# Map 13-05-2026 — K15-601 Calibrated (Final)
...
### Flash steps
- [ ] Flash `13-05-2026/core1.txt` ke core 1
- [ ] Flash `13-05-2026/core2.txt` ke core 2
- [ ] Flash `13-05-2026/juken.txt` ke parameter section
...
- Core1 ignition diturunkan targeted di zona TPS 30-70 & RPM 3000-7000 untuk recovery tenaga.
- Core1 IGN tetap dalam cap 26° dan 0.5° grid, zigzag=0.
- Core2 tetap profile power (cap 28°).


## Revision Update (2026-05-13 Final)

Nilai di section atas yang konflik dianggap superseded oleh update ini.

### Core1 (cam standar, anti-basah)
- BASEMAP diturunkan tipis di zona basah (idle/cruise/mid-load)
- IGN disusun ulang berbasis karakter Revo 109cc + noken standar
- IGN bawah dijinakkan (RPM <= 2000 tidak tinggi)
- IGN cap: **26°**
- Duty max: **66.28%** @ TPS 100% RPM 9000
- IGN range: **5.0..26.0°**, grid violations=0, zigzag=0

### Core2 (power, RON 95-98)
- FC range: **0..7**
- IGN cap: **28°**
- Duty max: **67.24%** @ TPS 100% RPM 9000
- IGN range: **9.0..28.0°**, grid violations=0, zigzag=0

### Policy
- Core1 untuk harian RON 92/95
- Core2 untuk tarik RON 95-98
